...
print(tcpm.transform(10, 10, 350, 2000))

# def _logistic(x, k, x0):
#     return 1 / (1 + np.exp(-k * (x - x0)))
#
#
# def clear_probability(e, d, m0, m):
#     x = m / m0
#     k = 0.5 * e + 0.3 * d - 2
#     x0 = 0.2 * e + 0.1 * d - 0.5
#
#     return round(_logistic(x, k, x0), 2)
#
#
# print(tcpm.transform(10, 10, 350, 70), clear_probability(10, 10, 350, 70))
# print(tcpm.transform(10, 10, 350, 700), clear_probability(10, 10, 350, 700))
# print(tcpm.transform(5, 10, 300, 300))
...
#         self.Xtrue = df.iloc[:, [0, 1, 3, 4]].values
#         self.ytrue = df['Clear Probability'].values
#
#         A_raw = df.to_numpy()
...
#
#
# cpm = ClearProbabilityModel()
# cpm.fit(SHEET_ID, ['Sheet6!A1:F'])
# print(cpm.transform(35, 350, 10, 10))
